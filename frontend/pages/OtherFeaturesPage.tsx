        ...
        <>
            ...
            <div className="card">
                ...
                {!overlay ? <div style={{padding:'20px'}}>Loading overlay settings...</div> : <>
                    ...
                    ].map(([key,label,description])=><ToggleSwitch key={key} label={label} description={description} checked={overlay.show?.[key] !== false} onChange={v=>applyOverlayPatch({show:{[key]:v}})}/>) }
