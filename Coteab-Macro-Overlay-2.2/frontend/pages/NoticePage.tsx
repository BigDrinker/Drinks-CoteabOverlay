...
const LOCAL_UPDATE_LOG = `# Coteab Macro Overlay v2.2.1 — Bug Fix Update
## Session and Overlay Fixes
- Session time now resets to 00:00:00 whenever the macro is closed and reopened.
- Fixed the overlay remaining open after the main macro window is closed.
- Fixed session runtime increasing faster than real elapsed time.
- Fixed selected biome notifications being sent twice to Discord webhooks.
`;
