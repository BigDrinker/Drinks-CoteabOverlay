...
class ConfigMixin:
    def save_config(self):
        ...
        config.update({
            ...
            "auto_update_enabled": self.auto_update_enabled_var.get() if hasattr(self, "auto_update_enabled_var") else self.config.get("auto_update_enabled", False),
    ...
    def import_config(self):
        try:
            ...
            if hasattr(self, "auto_update_enabled_var"): self.auto_update_enabled_var.set(config.get("auto_update_enabled", False))
