...
## Community overlay release

The repository includes a GitHub Actions workflow that produces a self-contained Windows folder and ZIP. End users do not need Python, Node.js, npm, or the source code.

For maintainers, see [`GITHUB_RELEASE_GUIDE.md`](GITHUB_RELEASE_GUIDE.md). For changes, see [`CHANGELOG.md`](CHANGELOG.md).
